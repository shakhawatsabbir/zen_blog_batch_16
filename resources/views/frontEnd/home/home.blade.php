...
@section('content')
    ...
    <section id="posts" class="posts">
        <div class="container" data-aos="fade-up">
            <div class="row g-5">
                @foreach($cultureblogs as  $cultureblog)
                    <div class="col-lg-4">
                        <div class="post-entry-1 lg">
                            <a href="single-post.html"><img src="{{ asset($cultureblog->image) }}" alt="" class="img-fluid"></a>
                            <div class="post-meta">
                                <span class="date">{{$cultureblog->category_name}}</span>
                                <span class="mx-1">&bullet;</span>
                                <span>{{date("M jS 'y" ,strtotime($cultureblog->date)) }}</span>
                            </div>
                            <h3><a href="single-post.html">{{$cultureblog->title}}</a></h3>
                            <p class="mb-4 d-block">{{$cultureblog->description}}</p>
                        ...
                        <div class="col-lg-4 border-start custom-border">
                            @foreach($populerblogs as $populerblog)
                                <div class="post-entry-1">
                                    <a href="{{route('blog.details',['slug'=>$populerblog->slug])}}">
                                    <img src="{{ asset($populerblog->image) }}" alt="" class="img-fluid" style="height: 120px; width: 100%"></a>
                                    <div class="post-meta"><span class="date">{{$populerblog->category_name}}</span>
                                        <span class="mx-1">&bullet;</span>
                                        <span>{{$populerblog->date}}</span>
                                    </div>
                                    <h6><a href="{{ route('blog.details',['slug'=>$populerblog->slug] )}}">{{ $populerblog->title }}</a></h6>
                                </div>
                            @endforeach
                        </div>
                        <div class="col-lg-4 border-start custom-border">
                            @foreach($latestblogs as $latestblog)
                                <div class="post-entry-1">
                                    <a href="{{route('blog.details',['slug'=>$latestblog->slug])}}">
                                        <img src="{{ asset($latestblog->image) }}" alt="" class="img-fluid" style="height: 120px; width: 100%">
                                    </a>
                                    <div class="post-meta"><span class="date">{{$latestblog->category_name}}</span>
                                        <span class="mx-1">&bullet;</span>
                                        <span>{{$latestblog->date}}</span>
                                    </div>
                                    <h6><a href="{{route('blog.details',['slug'=>$latestblog->slug])}}">{{$latestblog->title}}</a></h6>
                                </div>
                            @endforeach
                        </div>
