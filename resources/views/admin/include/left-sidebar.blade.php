    ...
    <div class="iconmenu">
        ...
        <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Blog">
                <button class="nav-link" data-bs-toggle="pill" data-bs-target="#blog" type="button"><i class="bi bi-box"></i></button>
            </li>
        </ul>
    </div>
    <div class="textmenu">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="blog">
                <div class="list-group list-group-flush">
                    ...
                    <a href="{{route('blog')}}" class="list-group-item"><i class="bi bi-envelope"></i>Blog</a>
